...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2022 at 08:24 PM
...
INSERT INTO `applications` (`application_id`, `user_email`, `application_subject`, `application_description`, `application_sender`, `application_sender_email`, `application_date`, `applicaiton_status`) VALUES
(7, 'admin@gmail.com', 'Exam Postponed', '<p>Sir we don&#39;t interested to attend exam</p>', 'Subhashis Mollick', 'smollickcseiu@gmail.com', '2022-04-14 20:24:43', 0);

-- --------------------------------------------------------

--
-- Table structure for table `book_assign_info`
--

CREATE TABLE `book_assign_info` (
  `BookAssignId` int(11) NOT NULL,
  `BookName` varchar(50) NOT NULL,
  `BookId` int(11) NOT NULL,
  `BookWriterName` varchar(50) NOT NULL,
  `StudentId` int(11) NOT NULL,
  `StudentName` varchar(50) NOT NULL,
  `BookIssueDate` date NOT NULL,
  `BookReturnDate` date NOT NULL,
  `IsReturnBook` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `book_assign_info`
--

INSERT INTO `book_assign_info` (`BookAssignId`, `BookName`, `BookId`, `BookWriterName`, `StudentId`, `StudentName`, `BookIssueDate`, `BookReturnDate`, `IsReturnBook`) VALUES
(2, 'System Design 2', 2, 'Alex Xu 2', 7, 'Subhashis', '2022-06-17', '2022-06-25', 1),
(3, 'System Design 2', 2, 'Alex Xu 2', 8, 'Bipro Kumar Sharma', '2022-06-18', '2022-06-25', 0),
(4, 'System Design 2', 2, 'Alex Xu 2', 9, 'Nibir Hossain', '2022-06-18', '2022-06-30', 0),
(5, 'Object Oriented Design', 3, 'Bala Goswami', 7, 'Subhashis Mollick', '2022-06-18', '2022-06-25', 0);
...
CREATE TABLE `book_list` (
  ...
  `BookName` varchar(50) NOT NULL,
  `BookWriterName` varchar(50) NOT NULL,
  `NumberOfTotalCopy` int(11) NOT NULL,
  `NumberOfRemainingCopy` int(11) NOT NULL,
  `PreviousTotalCopy` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `book_list` (`BookId`, `BookName`, `BookWriterName`, `NumberOfTotalCopy`, `NumberOfRemainingCopy`, `PreviousTotalCopy`) VALUES
(2, 'System Design 2', 'Alex Xu 2', 100, 99, 0),
(3, 'Object Oriented Design', 'Bala Goswami', 10, 9, 0);
...
(13, '2014-15', 'mfkhanbd2@gmail.com', '402', 'Sunday', '13:20:00');
...
INSERT INTO `meeting_agenda` (`agenda_id`, `meeting_id`, `meeting_title`, `agenda_list`) VALUES
(5, 28, 'Discussion', '<p>Cpu Discussion<br />\r\nContest perfomance</p>\r\n\r\n<p>Up solving.</p>');
...
(28, 'PC', 'Discussion', '2022-04-11', '14:00:00');
...
(74, 28, '', 'mfkhanbd2@gmail.com'),
(75, 28, '', 'ibrahim@cse.iu.ac.bd');
...
(93, 'mfkhanbd2@gmail.com', 'New Meeting (Discussion)', '<p><strong>New Meeting:</strong></p>\r\n\r\n<p>Please join the meeting.</p>\r\n\r\n<div id=\"gtx-trans\" style=\"position: absolute; left: -21px; top: 60px;\">\r\n<div class=\"gtx-trans-icon\">&nbsp;</div>\r\n</div> Time:14:00:00 (2022-04-11)', 'Dr. Md Aktaruzzaman', '2022-04-14 20:19:42', 0),
(94, 'ibrahim@cse.iu.ac.bd', 'New Meeting (Discussion)', '<p><strong>New Meeting:</strong></p>\r\n\r\n<p>Please join the meeting.</p>\r\n\r\n<div id=\"gtx-trans\" style=\"position: absolute; left: -21px; top: 60px;\">\r\n<div class=\"gtx-trans-icon\">&nbsp;</div>\r\n</div> Time:14:00:00 (2022-04-11)', 'Dr. Md Aktaruzzaman', '2022-04-14 20:19:42', 0),
(95, 'smollickcseiu@gmail.com', 'Exam', '<p>Your exam will be held on 15th April,2022</p>', 'Dr. Md Aktaruzzaman', '2022-04-14 20:21:57', 0),
(96, 'biprosharma@gmail.com', 'Exam', '<p>Your exam will be held on 15th April,2022</p>', 'Dr. Md Aktaruzzaman', '2022-04-14 20:21:57', 0),
(97, 'nibirhossain@gmail.com', 'Exam', '<p>Your exam will be held on 15th April,2022</p>', 'Dr. Md Aktaruzzaman', '2022-04-14 20:21:57', 0);
...
(14, 'Abdullah Al Mamun', 'mamun_iu', '2014-15', '181433', 'mamunbdiu@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '0170533333333', 'person3.jpg', '', '');
...
(1, 'Dr. Md Aktaruzzaman', 'admin@gmail.com', '25d55ad283aa400af464c76d713c07ad', '+880 1751639010', 'chairman_sir.jpg');
...
--
-- Indexes for table `book_assign_info`
--
ALTER TABLE `book_assign_info`
  ADD PRIMARY KEY (`BookAssignId`);
...
--
-- AUTO_INCREMENT for table `book_assign_info`
--
ALTER TABLE `book_assign_info`
  MODIFY `BookAssignId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `meeting_member_list`
  MODIFY `meeting_member_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;

--
-- AUTO_INCREMENT for table `notices`
--
ALTER TABLE `notices`
  MODIFY `notice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
