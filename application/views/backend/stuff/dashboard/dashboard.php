...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title badge badge-info" style="text-align: center;">Welcome <?php echo $stuff_info->stuff_username; ?></h5>
        <br><br>                   
    </div>
    <div class="panel-body">
        <div class="col-md-8">
            <div class="form-group">
                <label >Name</label>
                <input type="text"  class="form-control" value="<?=$stuff_info->stuff_username;?>" name="" readonly="">
            </div>
            <div class="form-group">
                <label >Email</label>
