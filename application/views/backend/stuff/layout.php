			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown dropdown-user" style="margin-top: 3%;background-color: #151815;border-radius: 5%">
					<a class="dropdown-toggle" data-toggle="dropdown">
						...
						<img src="<?php echo base_url('assets/images/'.$stuff_info->stuff_image) ?>">
						<?php } 
						else {?>
							<img src="<?php echo base_url('assets/images/person.JPG') ?>">
						<?php } ?>
						<span><?= $stuff_info->stuff_username;?></span>
						<i class="caret"></i>
					</a>

					<ul class="dropdown-menu dropdown-menu-right">
						<li><a href="<?php echo base_url('dashboard_stuff/see_own_profile'); ?>"><i class="icon-user-plus"></i> My profile</a></li>
						<li><a href="<?php echo base_url('dashboard_stuff/password_change') ?>"><i class="icon-cog5"></i> Update Password</a></li>
						<li><a href="<?php echo base_url('login_stuff/stuff_logout'); ?>"><i class="icon-switch2"></i> Logout</a></li>
					</ul>
				</li>
			</ul>
		</div>
