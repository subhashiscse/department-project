...
<body class="login-container">
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<!-- <a class="navbar-brand" href="home"><img style="height: 40px" src="assets/images/cse_logo.jpg" alt=""></a> -->
			<!-- <span>Online Department Design & Development System</span> -->
...
<div class="page-container">
	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="content">
				<!-- Simple login form -->
                <form method="POST" action="<?php echo site_url('login_admin/authentication_process') ?>">
