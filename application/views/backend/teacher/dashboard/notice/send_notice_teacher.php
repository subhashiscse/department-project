...
<body> 
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <form method="POST" enctype="multipart/form-data" action="<?php echo base_url('dashboard_teacher/save_notice_teacher'); ?>">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <table>
                        <?php foreach ($teacher_list->result() as $row) {
                            if($row->teacher_id!=$teacher_info->teacher_id){?>
                            <tr>
