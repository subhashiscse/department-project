    							...
    							<ul class="icons-list" >
    								<li class="dropdown">
    									...
    									<ul class="dropdown-menu dropdown-menu-right">
    										<li><a href="<?php echo base_url('dashboard_student/mark_notice/'.$row->notice_id); ?>"><i class="icon-file-excel"></i>Mark as read</a></li>
    										<li><a href="<?php echo base_url('dashboard_student/unmark_notice/'.$row->notice_id); ?>"><i class="icon-file-excel"></i>Mark as unread</a></li>
    									</ul>
    								</li>
    							</ul>
    						</td>
