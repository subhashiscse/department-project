...
<body> 
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <form method="POST" enctype="multipart/form-data" action="<?php echo base_url('dashboard_student/save_app_teacher'); ?>">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <table>
                        <?php foreach ($teacher_list->result() as $row) {?>
                            <tr>
                                <td><input type="checkbox" name="id[]" value="<?=$row->teacher_email;?>"></td>
                ...
                <div class="form-group">
                    ...
                    <textarea name="application_description" id="application_description" rows="10" cols="80">
                    </textarea>
                    <script>
