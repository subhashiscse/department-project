...
<body> 
    ...
    <div class="panel panel-flat">
        <div class="panel-heading" style="margin: 2%;">
            <h5 class="panel-title badge badge-info">Send Class Notice</h5>
            <br><br>
            <?php echo $this->session->flashdata('msg'); ?>
        </div>
        <div class="panel-body">
            <form method="POST" enctype="multipart/form-data" action="<?php echo base_url('dashboard_teacher/save_class_notice'); ?>">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <table>
                        <?php foreach ($session_list->result() as $row) {?>
                            <tr>
                                <td><input type="checkbox" name="id[]" value="<?=$row->session;?>"></td>
